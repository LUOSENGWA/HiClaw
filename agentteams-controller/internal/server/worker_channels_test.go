...
func TestChannelsUpstreamPathsMatchWorkerContract(t *testing.T) {
	cases := []struct {
		...
		},
		{
			"types",
			func(h *ChannelsHandler, rec *httptest.ResponseRecorder) {
				h.getChannelResource(rec, adminCaller(channelsRequest(http.MethodGet, "/api/v1/workers/placeholder/channels/types", "", "name", "daily-luo", "sub", "types")))
			},
		...
		},
		{
			"schemas",
			func(h *ChannelsHandler, rec *httptest.ResponseRecorder) {
				h.getChannelResource(rec, adminCaller(channelsRequest(http.MethodGet, "/api/v1/workers/placeholder/channels/schemas", "", "name", "daily-luo", "sub", "schemas")))
			},
		...
		},
		{
			"health",
			func(h *ChannelsHandler, rec *httptest.ResponseRecorder) {
				h.getChannelHealth(rec, adminCaller(channelsRequest(http.MethodGet, "/api/v1/workers/placeholder/channels/qq/health", "", "name", "daily-luo", "channel", "qq")))
			},
		...
		},
		{
			"qrcode",
			func(h *ChannelsHandler, rec *httptest.ResponseRecorder) {
				h.getChannelQrcode(rec, adminCaller(channelsRequest(http.MethodGet, "/api/v1/workers/placeholder/channels/qq/qrcode", "", "name", "daily-luo", "channel", "qq")))
			},
		...
		},
		{
			"qrcode-status",
			func(h *ChannelsHandler, rec *httptest.ResponseRecorder) {
				h.getQrcodeStatus(rec, adminCaller(channelsRequest(http.MethodGet, "/api/v1/workers/placeholder/channels/qq/qrcode/status?token=tok", "", "name", "daily-luo", "channel", "qq")))
			},
